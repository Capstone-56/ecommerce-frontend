...
import {
  ...
  CURRENCY_LOCALE_MAP,
} from "@/domain/enum/currency";
import api from "@/api";
import { AddressModel, AddressModelData } from "@/domain/models/AddressModel";
  ...
  useEffect(() => {
    (async () => {
      ...
      try {
        ...
        const defaultAddress: AddressModelData = data.addresses?.find(
          (address: any) => {
