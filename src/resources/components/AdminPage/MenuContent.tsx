...
const secondaryListItems = [
  { text: 'Settings', icon: <SettingsRoundedIcon />, to: Constants.ADMIN_DASHBOARD_ROUTE + "/settings", index: 6 },
];
...
export default function MenuContent() {
  ...
  return (
    <>
      ...
      <Divider sx={{ backgroundColor: "#8EB5C0", maxWidth: "80%", mx: "auto" }} />
      <Stack sx={{ flexGrow: 1, p: 1, justifyContent: 'space-between', backgroundColor: '#212E4A', minHeight: "90%" }}>
        <List dense>
          {mainListItems.map((item, index) => (
            <ListItem key={item.text} disablePadding sx={{ display: 'block' }}>
              ...
              >
                <ListItemIcon sx={{ color: "#8EB5C0" }}>{item.icon}</ListItemIcon>
